...
This repository covers distributed protocol, signed messaging, allow-lists, node identity, and interoperability. This document establishes a baseline and must be revised as architecture and evidence change.
