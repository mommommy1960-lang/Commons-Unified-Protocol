...
This repository addresses distributed protocol, signed messaging, allow-lists, node identity, and interoperability. Unless a release states otherwise with reproducible evidence, its components are research, prototype, documentation, or simulation artifacts and are not approved for safety-critical production use.
